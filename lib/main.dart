                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/manu.png', height: 40),
                        SizedBox(width: 20),
                        RichText(
                          text: TextSpan(
                            style: TextStyle(
                ...
                child: Row(
                  children: [
                    FinishedMatchCard(
                      ...
                      date: ' Today',
                      team1Logo: 'assets/images/realmadrid.png',
                      team2Logo: 'assets/images/manc.png',
                      score: '4 : 3',
                    ),
                    SizedBox(width: 10),
                    FinishedMatchCard(
                      league: 'League B',
                      date: '15 July 2020',
                      team1Logo: 'assets/images/liverpool.png',
            ...
            ListTile(
              leading: CircleAvatar(
                backgroundImage: AssetImage(
                  'assets/images/rashford.png',
                ),
              ),
              title: Text('Top Player'),
              subtitle: Text('Marcus Rashford'),
            ),
            SizedBox(height: 20),
            Text(
              'Match Stats',
